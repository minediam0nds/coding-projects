...
its worth noting that the most of the time i spent on this program was manually finding the coordinates for the 'bounding boxes', and the pixel coordinates for PIL to draw on through guess and check LOL
